        ...
        {isMenuOpen && (
            <div className="md:hidden px-4 pb-4 space-y-4">
              <nav className="flex flex-col space-y-2 text-gray-300 font-medium">
                <Link to="/about" className="hover:text-indigo-400 transition block py-2">About</Link>
                <Link to="/how-it-works" className="hover:text-indigo-400 transition block py-2">How it Works</Link>
                <Link to="/contact" className="hover:text-indigo-400 transition block py-2">Contact</Link>
              </nav>
