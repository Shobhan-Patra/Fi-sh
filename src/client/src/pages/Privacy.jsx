  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 text-gray-300">
      ...
      <div className="space-y-6">     
        <p>Thank you for using Fi-sh. This Privacy Policy explains how we handle your information.</p>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-white mb-3">2. Information Sharing</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-white mb-3">3. Data Retention & Deletion</h2>
