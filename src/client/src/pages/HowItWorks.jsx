  ...
  return (
    <div className="bg-gray-900 py-20 text-gray-100">
      <div className="max-w-5xl mx-auto px-6">
        <h2 className="text-4xl font-bold text-indigo-400 text-center">How it Works</h2>
        <p className="mt-4 text-lg text-gray-300 text-center">
          Sharing files with Fi-sh is quick and effortless.
          Here’s how you can get started in 4 simple steps:
        </p>
